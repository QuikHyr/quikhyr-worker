                ...
                return Column(
                  children: [
                    ...
                    MultiSelectDialogField<SubserviceModel>(
                      validator: (value) {
                        if (value == null || value.isEmpty) {
                          return 'Please select at least one subservice';
                        }
                        return null;
                      },
                    ...
                    child: BlocBuilder<SignUpBloc, SignUpState>(
                      builder: (context, state) {
                        ...
                        if (state is SignUpInitial || state is SignUpSuccess) {
                          ...
                          //!!ROLL BACK IF ANY ISSUE BEFORE PRESENTATION
                          return LongIconButton(
                            text: buttonText,
                            onPressed: onButtonPressed,
                            svgPath: QuikAssetConstants.rightArrowSvg,
...
String? validateServicesSelection(List<ServiceModel> selectedServices,
    List<SubserviceModel> selectedSubServices) {
  if (selectedServices.isEmpty || selectedSubServices.isEmpty) {
    return 'Please select at least one service and one subservice';
  }
  return null;
}
